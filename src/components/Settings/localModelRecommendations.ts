...
export const LOCAL_MODEL_RECOMMENDATIONS: LocalModelRecommendation[] = [
  // 8GB (3–4B)
  { ram: "8GB", name: "Qwen3 4B Instruct 2507", tag: "qwen3:4b-instruct-2507", note: "中文最佳、原生非思考", primary: true },
  { ram: "8GB", name: "Gemma 3 4B", tag: "gemma3:4b", note: "快、标点好；中文细节弱、可能加 emoji", primary: false },
  { ram: "8GB", name: "Granite 4.0 Micro", tag: "granite4:micro", note: "最省内存、输出老实；中文一般", primary: false },
  // 16GB (7–8B)
  { ram: "16GB", name: "Qwen3 8B", tag: "qwen3:8b", note: "中文强、平衡（已自动 /no_think）", primary: true },
  { ram: "16GB", name: "Gemma 3 12B", tag: "gemma3:12b", note: "标点/多语好；无 system role、比 Qwen 慢", primary: false },
  { ram: "16GB", name: "Granite 4.0 H-Tiny", tag: "granite4:tiny-h", note: "省内存、指令老实；中文一般", primary: false },
  // 24GB (14B)
  { ram: "24GB", name: "Qwen3 14B", tag: "qwen3:14b", note: "中文润色质量高（已自动 /no_think）", primary: true },
  { ram: "24GB", name: "Gemma 3 27B", tag: "gemma3:27b", note: "质量高、标点好；占用大、无 system role", primary: false },
  { ram: "24GB", name: "Qwen3 30B-A3B Instruct 2507", tag: "qwen3:30b-a3b-instruct-2507", note: "MoE 快、原生非思考；24GB 余量偏紧", primary: false },
  // 32GB+ (14–32B / 快速 MoE)
  { ram: "32GB+", name: "Qwen3 30B-A3B Instruct 2507", tag: "qwen3:30b-a3b-instruct-2507", note: "MoE、原生非思考、快、中文强", primary: true },
  { ram: "32GB+", name: "Qwen3 32B", tag: "qwen3:32b", note: "质量最高，但慢（已自动 /no_think）", primary: false },
];
