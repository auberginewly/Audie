...
// tags / status are mock (visual only); the active pick maps to the
...
export const MODELS: ModelMeta[] = [
  { id: "doubao", name: "豆包", type: "asr", source: "cloud", icon: "audio-lines", model: "Doubao ASR 2.0 (Hourly)", tags: ["云端", "均衡", "实时"] },
  { id: "groq", name: "Groq", type: "asr", source: "cloud", icon: "audio-lines", model: "whisper-large-v3-turbo", tags: ["云端", "快速"] },
  { id: "whisper-local", name: "Whisper", type: "asr", source: "local", icon: "audio-lines", model: "whisper-large-v3", tags: ["本地", "离线"] },
  { id: "deepseek", name: "DeepSeek", type: "llm", source: "cloud", icon: "sparkles", model: "DeepSeek V4 Flash", tags: ["云端", "推荐"] },
  { id: "openai", name: "OpenAI", type: "llm", source: "cloud", icon: "sparkles", model: "gpt-4o-mini", tags: ["云端", "兼容"] },
];
