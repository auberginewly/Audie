// Audie iconography — Lucide glyph paths (ISC licensed), embedded so the
// component stays self-contained (React only, no npm). Stroke 1.5 by default
// for the thin, calm system-utility feel. The codebase shipped no icon set;
// Lucide is the chosen match for Geist's aesthetic.

import type { CSSProperties, SVGProps } from "react";

const ICONS = {
  mic: '<path d="M12 2a3 3 0 0 0-3 3v7a3 3 0 0 0 6 0V5a3 3 0 0 0-3-3Z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" x2="12" y1="19" y2="22"/>',
  home: '<path d="M3 9.5 12 3l9 6.5"/><path d="M5 10v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V10"/><path d="M9 21v-6a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v6"/>',
